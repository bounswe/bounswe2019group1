...
this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var q=a.dataSeriesIndexes[t],C=this.data[q],v=C.dataPoints;if(0<v.length){var E=5<e&&C.bevelEnabled?!0:!1;b.strokeStyle="#4572A7 ";for(h=0;h<v.length;h++)if(c=v[h].x.getTime?v[h].x.getTime():v[h].x,!(c<a.axisX.dataInfo.viewPortMin||c>a.axisX.dataInfo.viewPortMax)&&"number"===typeof v[h].y){r=a.axisX.convertValueToPixel(c);var G=r-a.plotType.plotUnits.length*e/2+a.main*e<<0,u=G+e<<0,s;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&
...
this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var q=a.dataSeriesIndexes[t],C=this.data[q],v=C.dataPoints;if(0<v.length){var E=5<e&&C.bevelEnabled?!0:!1;b.strokeStyle="#4572A7 ";for(h=0;h<v.length;h++)if(c=v[h].x.getTime?v[h].x.getTime():v[h].x,!(c<a.axisX.dataInfo.viewPortMin||c>a.axisX.dataInfo.viewPortMax)&&"number"===typeof v[h].y){p=a.axisX.convertValueToPixel(c);var u=p-a.plotType.plotUnits.length*e/2+a.main*e<<0,s=u+e<<0,x;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&
...
axis:this.parent.options,crosshair:this.options,value:v}):x(this.options.label)?ea(v,this.valueFormatString,this.chart._cultureInfo):this.label}else"waterfall"===this.parent.dataSeries[q].type?(k=1===r.lineWidth%2?(this.parent.convertValueToPixel(n.dataSeries.dataPointEOs[n.main].cumulativeSum)<<0)+0.5:this.parent.convertValueToPixel(n.dataSeries.dataPointEOs[n.main].cumulativeSum)<<0,l.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:n.dataSeries.dataPointEOs[n.main].cumulativeSum}):x(this.options.label)?ea(n.dataSeries.dataPointEOs[n.main].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label):(k=1===r.lineWidth%2?(this.parent.convertValueToPixel(n.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(n.dataPoint.y)<<0,l.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:n.dataPoint.y}):x(this.options.label)?ea(n.dataPoint.y,this.valueFormatString,
...
this.contentDiv.style.borderColor=this.options.borderColor?this.options.borderColor:g[0].dataSeries.color?g[0].dataSeries.color:g[0].dataSeries._colorSet[d.main%g[0].dataSeries._colorSet.length]:this.contentDiv.style.borderRightColor=this.contentDiv.style.borderLeftColor=this.contentDiv.style.borderColor=this.options.borderColor?this.options.borderColor:g[0].dataPoint.color?g[0].dataPoint.color:g[0].dataSeries.color?g[0].dataSeries.color:g[0].dataSeries._colorSet[g[0].main%g[0].dataSeries._colorSet.length],
...
null===f&&(f=""),!0===this.reversed?(f=this.chart.replaceKeywordsWithValue(g,c,b,d)+f,l<a.length-1&&(f="</br>"+f)):(f+=this.chart.replaceKeywordsWithValue(g,c,b,d),l<a.length-1&&(f+="</br>")));null!==f&&(f=h+f)}else{b=a[0].dataSeries;c=a[0].dataPoint;d=a[0].main;if(null===c.toolTipContent||"undefined"===typeof c.toolTipContent&&null===b.options.toolTipContent)return null;"line"===b.type||"stepLine"===b.type||"spline"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"column"===
...
g=d.dataPoints[c.dataPointIndex],k=c.dataPointIndex;c.eventParameter={x:b.x,y:b.y,dataPoint:g,dataSeries:d.options,dataPointIndex:k,dataSeriesIndex:d.main,chart:this.chart};c.eventContext={context:g,userContext:g,mouseover:"mouseover",mousemove:"mousemove",mouseout:"mouseout",click:"click"};f.push(c);c=this.objectMap[d.id];c.eventParameter={x:b.x,y:b.y,dataPoint:g,dataSeries:d.options,dataPointIndex:k,dataSeriesIndex:d.main,chart:this.chart};c.eventContext={context:d,userContext:d.options,mouseover:"mouseover",
