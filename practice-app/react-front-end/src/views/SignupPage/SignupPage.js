...
export default function SignupPage(props) {
  ...
  if (isLocationSelected.selected) {
    MapOrForm = <LocationPickerMap location={location} setLocation={setLocation} setIsLocationSelected={setIsLocationSelected} />
  } else {
    MapOrForm = <GridContainer justify="center">
          ...
          <form className={classes.form}>
            ...
            <CardBody>
              ...
              <CustomInput
                labelText= "Location..."
                id="location"
                onClick={() => { setIsLocationSelected({ selected: true }) }}
                formControlProps={{
                  fullWidth: true
                }}
