...
urlpatterns = [
    ...
    url(r'^creatorlistmobile/', views.CreatorListMobileAPIView.as_view(), name="create"),
    ...
    url(r'^getannotationsmobile/', views.AnnotationListMobileAPIView.as_view(), name="create"),
