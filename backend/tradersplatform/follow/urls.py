...
urlpatterns = [
    ...
    url(r'^rejectfollow/(?P<pk>[0-9_]+)/', views.RejectFollowAPIView.as_view(), name="register"),
    url(r'^followList/', views.ListFollowAPIView.as_view(), name="list"),
    url(r'^listFollower/', views.ListFollowerAPIView.as_view(), name="list"),
    url(r'^listFollowerPending/', views.ListFollowerPendingAPIView.as_view(), name="list"),
    ...
    url(r'^listFollowingPending/', views.ListFollowingPendingAPIView.as_view(), name="list"),
